...
const domContainer = document.querySelector('#chat-room');
...
const ChatRoom = () => {
  ...
  const watchGetProfile = async () => {
    const response = await axios.get(`${window.appConfig.baseUrl}/profile`, window.appConfig.axiosConfig)
  ...
  const onHandleSendMessage = async e => {
    e.preventDefault()
    const response = await axios.post(`${window.appConfig.baseUrl}/messages`, {
      message
    }, window.appConfig.axiosConfig)
    ...
    <div class="flex flex-row h-full w-full overflow-x-hidden">
      <div class="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
        ...
        >
          ...
          <div class="text-sm font-semibold mt-2">{profile.name}</div>
        ...
        >
          ...
          >
            ...
            <div class="flex-grow ml-4">
              <form onSubmit={onHandleSendMessage} class="relative w-full">
                <input
                  value={message}
